...
class BuildHelper extends AppHelper {
	...
	public function item($supply, $name) {
		...
		return "<a class='list-group-item'><span class='badge'><img src='/build/img/protoss_supply.gif'>&nbsp;$supply</span><span style='margin-left: 10px'>".htmlspecialchars($name)."</span></a>";
	}
